...
class Personalized4Screen extends StatefulWidget {
  const Personalized4Screen({Key? key}) : super(key: key);

  @override
  State<Personalized4Screen> createState() => _Personalized4ScreenState();
}

class _Personalized4ScreenState extends State<Personalized4Screen> {
                      ...
                      children: [
                        Padding(
                          ...
                          child: GestureDetector(
                            ...
                            MaterialPageRoute(builder: (BuildContext context) => const NavigationScreen())
                            );
                            },
                            child: Container(
                              height: 64.0,
